...
# 적 캐릭터
enemy = pygame.image.load("C:/backup/Y6952657/KYG/worksapce/python/ex/pygame_basic/enemy.png")
...
enemy_y_pos = (screen_height / 2) - (enemy_height / 2) # 화면 새로 크기의 가장 아래에 해당하는 곳에 위치
